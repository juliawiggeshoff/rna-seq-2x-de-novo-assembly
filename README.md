...
Once your analyses have successfuly finished, you can now use Snakemake one last time to generate a report. It describes the used software versions, the reports from fastqc, the final graph generated by the BUSCO report. It also included the commands as paths to in and output files. 
